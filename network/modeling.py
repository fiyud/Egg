...
#     xception
# )
from .backbone import mobilenetv4
...
def _segm_mobilenetv4(mobilev4_type, num_classes):
    backbone = mobilenetv4.MobileNetV4(mobilev4_type)
    inplanes = backbone.combined_features_inplanes
    aspp_dilate = [6, 12, 18]
...
def _load_mobilev4_backbone_model(mobilev4_type, num_classes):
    model = _segm_mobilenetv4(mobilev4_type, num_classes)
    return model
